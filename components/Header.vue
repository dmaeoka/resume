<template>
	<header class="header md:h-full z-50 md:w-20 w-full fixed flex flex-row md:flex-col bg-gray-900 text-white justify-between h-20 md:top-0 md:bottom-0 md:min-h-screen">
		...
		<div class="menu flex flex-1 md:flex-col items-center justify-center">
			<div class="menu-title text-gray-500 text-xs text-center hidden md:block font-display">MENU</div>
			<ol class="menu-items flex flex-row md:block ml-auto md:mx-auto">
				<li
					v-for="menu in info.menu" :key="menu.id"
